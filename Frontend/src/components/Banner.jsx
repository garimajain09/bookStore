            ...
            <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row">
                <div className="w-full order-2 md:order-1 md:w-1/2 md:mt-32 mt-12">
                    <div className="space-y-12">
                        ...
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem obcaecati quas, similique porro, possimus molestiae culpa quasi nesciunt est doloremque pariatur exercitationem cupiditate necessitatibus vitae ab officia vero amet minima.</p>
